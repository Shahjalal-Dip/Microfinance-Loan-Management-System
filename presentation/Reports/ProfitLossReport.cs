...
{
    public partial class ProfitLossReport : BaseForm
    {
        private int n;
        public ProfitLossReport(int n = 0)
        {
            InitializeComponent();
            this.n = n;
            GenerateReport();
        ...
        private void GenerateReport()
        {
            ...
            DataTable dt = reportService.GetProfitLossReport(DateTime.Now.AddMonths(-1), DateTime.Now);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "ProfitLossReport.txt";
        ...
        private string ConvertDataTableToText(DataTable dt)
        {
            ...
            sb.Append("----------------------Profit and Loss Report--------------------------\n");
