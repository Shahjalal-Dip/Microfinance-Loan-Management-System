...
{
    public partial class CollectionReport : BaseForm
    {
        private int n;
        public CollectionReport(int n = 0)
        {
            InitializeComponent();
            this.n = n;
            GenerateReport();
        ...
        private void GenerateReport()
        {
            ...
            DataTable dt = reportService.GetCollectionReport(DateTime.Now.AddMonths(-1), DateTime.Now);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "CollectionReport.txt";
